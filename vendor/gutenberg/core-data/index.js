...
/*!****************************************************!*\
  !*** ./packages/core-data/build-module/actions.js ***!
  \****************************************************/
/*! exports provided: receiveUserQuery, receiveCurrentUser, addEntities, receiveEntityRecords, receiveThemeSupports, receiveEmbedPreview, editEntityRecord, undo, redo, saveEntityRecord, saveEditedEntityRecord, receiveUploadPermissions, receiveUserPermission, receiveAutosaves */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _queried_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./queried-data */ "./packages/core-data/build-module/queried-data/index.js");
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./entities */ "./packages/core-data/build-module/entities.js");
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controls */ "./packages/core-data/build-module/controls.js");



var _marked =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(editEntityRecord),
    _marked2 =
/*#__PURE__*/
...
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(redo),
    _marked4 =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(saveEntityRecord),
    _marked5 =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(saveEditedEntityRecord);
...
function receiveUserQuery(queryID, users) {
  return {
    ...
    users: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["castArray"])(users),
    queryID: queryID
  };
}
/**
...
function receiveEntityRecords(kind, name, records, query) {
  ...
  // on the server.
  if (kind === 'postType') {
    records = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["castArray"])(records).map(function (record) {
      return record.status === 'auto-draft' ? Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, record, {
        title: ''
      }) : record;
    });
  }
  ...
  if (query) {
    action = Object(_queried_data__WEBPACK_IMPORTED_MODULE_3__["receiveQueriedItems"])(records, query);
  } else {
    action = Object(_queried_data__WEBPACK_IMPORTED_MODULE_3__["receiveItems"])(records);
  }

  return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action, {
    kind: kind,
    name: name,
...
function editEntityRecord(kind, name, recordId, edits) {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function editEntityRecord$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          options = _args.length > 4 && _args[4] !== undefined ? _args[4] : {};
          _context.next = 3;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getEntity', kind, name);
        ...
        case 3:
          ...
          _context.next = 10;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getRawEntityRecord', kind, name, recordId);

        case 10:
          record = _context.sent;
          _context.next = 13;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getEditedEntityRecord', kind, name, recordId);
        ...
        case 13:
          ...
          edit = {
            ...
            edits: Object.keys(edits).reduce(function (acc, key) {
              ...
              var value = mergedEdits[key] ? Object(lodash__WEBPACK_IMPORTED_MODULE_2__["merge"])({}, editedRecordValue, edits[key]) : edits[key];
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isEqual"])(recordValue, value) ? undefined : value;
              return acc;
            }, {}),
            transientEdits: transientEdits
          };
          return _context.abrupt("return", Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({
            type: 'EDIT_ENTITY_RECORD'
          }, edit, {
            meta: {
              undo: !options.undoIgnore && Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, edit, {
...
function undo() {
  var undoEdit;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function undo$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getUndoEdit');
        ...
        case 5:
          _context2.next = 7;
          return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({
            type: 'EDIT_ENTITY_RECORD'
          }, undoEdit, {
            meta: {
              isUndo: true
...
function redo() {
  var redoEdit;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function redo$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getRedoEdit');
...
function saveEntityRecord(kind, name, record) {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function saveEntityRecord$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 7:
          entityIdKey = entity.key || _entities__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_ENTITY_KEY"];
        ...
        case 15:
          ...
          _context4.next = 19;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getCurrentUser');

        case 19:
          currentUser = _context4.sent;
          currentUserId = currentUser ? currentUser.id : undefined;
          _context4.next = 23;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getAutosave', persistedRecord.type, persistedRecord.id, currentUserId);
        ...
        case 23:
          ...
          // have a value.
          data = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, persistedRecord, autosavePost, record);
          data = Object.keys(data).reduce(function (acc, key) {
            if (['title', 'excerpt', 'content'].includes(key)) {
              // Edits should be the "raw" attribute values.
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(data[key], 'raw', data[key]);
            }
        ...
        case 28:
          ...
          newRecord = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, persistedRecord, data, updatedRecord);
          newRecord = Object.keys(newRecord).reduce(function (acc, key) {
            // These properties are persisted in autosaves.
            if (['title', 'excerpt', 'content'].includes(key)) {
              // Edits should be the "raw" attribute values.
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(newRecord[key], 'raw', newRecord[key]);
            } else if (key === 'status') {
              ...
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(persistedRecord[key], 'raw', persistedRecord[key]);
            }
        ...
        case 40:
          ...
          if (kind === 'postType' && persistedRecord.status === 'auto-draft' && !_data.status) {
            _data = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, _data, {
              status: 'draft'
            });
          }
...
function saveEditedEntityRecord(kind, name, recordId, options) {
  var edits, record;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function saveEditedEntityRecord$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('hasEditsForEntityRecord', kind, name, recordId);
        ...
        case 4:
          _context5.next = 6;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_5__["select"])('getEntityRecordNonTransientEdits', kind, name, recordId);

        case 6:
          edits = _context5.sent;
          record = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({
            id: recordId
          }, edits);
...
function receiveAutosaves(postId, autosaves) {
  return {
    ...
    postId: postId,
    autosaves: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["castArray"])(autosaves)
  };
}
...
/***/ "./packages/core-data/build-module/controls.js":
/*!*****************************************************!*\
  !*** ./packages/core-data/build-module/controls.js ***!
  \*****************************************************/
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actions */ "./packages/core-data/build-module/actions.js");
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controls */ "./packages/core-data/build-module/controls.js");
...
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reducer */ "./packages/core-data/build-module/reducer.js");
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controls */ "./packages/core-data/build-module/controls.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./selectors */ "./packages/core-data/build-module/selectors.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./actions */ "./packages/core-data/build-module/actions.js");
/* harmony import */ var _resolvers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./resolvers */ "./packages/core-data/build-module/resolvers.js");
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./entities */ "./packages/core-data/build-module/entities.js");
/* harmony import */ var _name__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./name */ "./packages/core-data/build-module/name.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./packages/core-data/build-module/utils/index.js");
...
/***/ "./packages/core-data/build-module/queried-data/index.js":
/*!***************************************************************!*\
  !*** ./packages/core-data/build-module/queried-data/index.js ***!
  \***************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actions */ "./packages/core-data/build-module/queried-data/actions.js");
...
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selectors */ "./packages/core-data/build-module/queried-data/selectors.js");
...
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reducer */ "./packages/core-data/build-module/queried-data/reducer.js");
...
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils */ "./packages/core-data/build-module/utils/index.js");
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../entities */ "./packages/core-data/build-module/entities.js");
/* harmony import */ var _get_query_parts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./get-query-parts */ "./packages/core-data/build-module/queried-data/get-query-parts.js");
...
function items() {
  ...
  switch (action.type) {
    case 'RECEIVE_ITEMS':
      ...
      return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, action.items.reduce(function (acc, value) {
        var itemId = value[key];
        acc[itemId] = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["conservativeMapItem"])(state[itemId], value);
        return acc;
      }, {}));
  }
...
Object(_utils__WEBPACK_IMPORTED_MODULE_3__["replaceAction"])(function (action) {
  ...
  if (action.query) {
    return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, action, Object(_get_query_parts__WEBPACK_IMPORTED_MODULE_5__["default"])(action.query));
  }
...
/* harmony import */ var _get_query_parts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./get-query-parts */ "./packages/core-data/build-module/queried-data/get-query-parts.js");
/**
 * External dependencies
 */
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils */ "./packages/core-data/build-module/utils/index.js");
/* harmony import */ var _queried_data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./queried-data */ "./packages/core-data/build-module/queried-data/index.js");
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./entities */ "./packages/core-data/build-module/entities.js");
...
function entity(entityConfig) {
  ...
  // an unhandled action.
  Object(_utils__WEBPACK_IMPORTED_MODULE_7__["ifMatchingAction"])(function (action) {
    return action.name && action.kind && action.name === entityConfig.name && action.kind === entityConfig.kind;
  }), // Inject the entity config into the action.
  Object(_utils__WEBPACK_IMPORTED_MODULE_7__["replaceAction"])(function (action) {
    return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, action, {
      key: entityConfig.key || _entities__WEBPACK_IMPORTED_MODULE_9__["DEFAULT_ENTITY_KEY"]
    });
  })])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_5__["combineReducers"])({
    queriedData: _queried_data__WEBPACK_IMPORTED_MODULE_8__["reducer"],
    edits: function edits() {
      ...
      switch (action.type) {
        case 'RECEIVE_ITEMS':
          var nextState = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state);
          ...
          try {
            var _loop = function _loop() {
              ...
              var nextEdits = Object.keys(edits).reduce(function (acc, key) {
                ...
                // comparison.
                !Object(lodash__WEBPACK_IMPORTED_MODULE_4__["isEqual"])(edits[key], Object(lodash__WEBPACK_IMPORTED_MODULE_4__["get"])(record[key], 'raw', record[key]))) {
                  acc[key] = edits[key];
                }
        ...
        case 'EDIT_ENTITY_RECORD':
          var nextEdits = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state[action.recordId], action.edits);
          ...
          return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])({}, action.recordId, nextEdits));
      }
    ...
    saving: function saving() {
      ...
      switch (action.type) {
        ...
        case 'SAVE_ENTITY_RECORD_FINISH':
          return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])({}, action.recordId, {
...
function entitiesConfig() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _entities__WEBPACK_IMPORTED_MODULE_9__["defaultEntities"];
  var action = arguments.length > 1 ? arguments[1] : undefined;
  ...
  switch (action.type) {
    case 'EDIT_ENTITY_RECORD':
      if (action.meta.isUndo || action.meta.isRedo) {
        var _nextState = Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(state);
      ...
      if (!Object.keys(action.edits).some(function (key) {
        ...
        var _nextState2 = Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(state);

        _nextState2.flattenedUndo = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state.flattenedUndo, action.edits);
      ...
      nextState.push({
        ...
        edits: Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state.flattenedUndo, action.meta.undo.edits)
      ...
      if (!_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_6___default()(comparisonUndoEdits, comparisonEdits)) {
        nextState.push({
          kind: action.kind,
          name: action.name,
...
function userPermissions() {
  ...
  switch (action.type) {
    case 'RECEIVE_USER_PERMISSION':
      return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])({}, action.key, action.isAllowed));
  }
...
function autosaves() {
  ...
  switch (action.type) {
    case 'RECEIVE_AUTOSAVES':
      ...
      return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])({}, postId, autosavesData));
  }
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./actions */ "./packages/core-data/build-module/actions.js");
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./entities */ "./packages/core-data/build-module/entities.js");
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controls */ "./packages/core-data/build-module/controls.js");
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function getEntityRecords$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 7:
          path = Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_3__["addQueryArgs"])(entity.baseURL, Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, query, {
            context: 'edit'
          }));
          _context4.next = 10;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["apiFetch"])({
...
/*!******************************************************!*\
  !*** ./packages/core-data/build-module/selectors.js ***!
  \******************************************************/
/*! exports provided: isRequestingEmbedPreview, getAuthors, getCurrentUser, getUserQueryResults, getEntitiesByKind, getEntity, getEntityRecord, getRawEntityRecord, getEntityRecords, getEntityRecordEdits, getEntityRecordNonTransientEdits, hasEditsForEntityRecord, getEditedEntityRecord, isAutosavingEntityRecord, isSavingEntityRecord, getLastEntitySaveError, getUndoEdit, getRedoEdit, hasUndo, hasRedo, getThemeSupports, getEmbedPreview, isPreviewEmbedFallback, hasUploadPermissions, canUser, getAutosaves, getAutosave, hasFetchedAutosaves, getReferenceByDistinctEdits */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/deprecated */ "@wordpress/deprecated");
/* harmony import */ var _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_deprecated__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _name__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./name */ "./packages/core-data/build-module/name.js");
/* harmony import */ var _queried_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./queried-data */ "./packages/core-data/build-module/queried-data/index.js");
...
var getRawEntityRecord = Object(rememo__WEBPACK_IMPORTED_MODULE_1__["default"])(function (state, kind, name, key) {
  ...
  return record && Object.keys(record).reduce(function (acc, _key) {
    ...
    acc[_key] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(record[_key], 'raw', record[_key]);
    return acc;
  }, {});
}, function (state) {
...
var getEditedEntityRecord = Object(rememo__WEBPACK_IMPORTED_MODULE_1__["default"])(function (state, kind, name, recordId) {
  return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, getRawEntityRecord(state, kind, name, recordId), getEntityRecordEdits(state, kind, name, recordId));
}, function (state) {
  return [state.entities.data];
});
/**
...
/***/ "./packages/core-data/build-module/utils/index.js":
/*!********************************************************!*\
  !*** ./packages/core-data/build-module/utils/index.js ***!
  \********************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _conservative_map_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./conservative-map-item */ "./packages/core-data/build-module/utils/conservative-map-item.js");
...
/* harmony import */ var _if_matching_action__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./if-matching-action */ "./packages/core-data/build-module/utils/if-matching-action.js");
...
/* harmony import */ var _on_sub_key__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./on-sub-key */ "./packages/core-data/build-module/utils/on-sub-key.js");
...
/* harmony import */ var _replace_action__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./replace-action */ "./packages/core-data/build-module/utils/replace-action.js");
...
/* harmony import */ var _with_weak_map_cache__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./with-weak-map-cache */ "./packages/core-data/build-module/utils/with-weak-map-cache.js");
